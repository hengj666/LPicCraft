    ...
    def run_script(self):  
        ...
        try:  
            with open('script_file/temp_filter.json', 'r') as file:  
                ...
                # 根据"out"字段的值来决定后续操作  
                if out_value == 'yes':  
                    subprocess.run(["python", "ceshi.py"])  
    ...
    def colorize_log_text(self):
        ...
        for keyword, color in keyword_colors.items():
            ...
            while index != -1:
                ...
                cursor.movePosition(QtWidgets.QTextCursor.EndOfWord, QtWidgets.QTextCursor.KeepAnchor)
                cursor.mergeCharFormat(QtWidgets.QTextCharFormat())
